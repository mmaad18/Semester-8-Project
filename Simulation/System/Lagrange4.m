...
Q_i = {0 0 0}; Q_e = {0 0 0};
R   = 0;
par = {th1 th1_d th2 th2_d th3 th3_d g m0 m1 m2 m3 l1 l2 l3};

% Solve Lagrange equations and save DE as .m file
UF  = EulerLagrange(L,X,Q_i,Q_e,R,par,'m','Kugle_sys8');

% Create Simulink block
SimBlock  = EulerLagrange(L,X,Q_i,Q_e,R,par,'s','Kugle_sys8');